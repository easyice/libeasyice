...
extern int  ReadVUI(seq_parameter_set_rbsp_t *sps, Bitstream *s);
extern int  ReadHRDParameters(hrd_parameters_t *hrd,Bitstream *s);

extern void PPSConsistencyCheck (pic_parameter_set_rbsp_t *pps);
extern void SPSConsistencyCheck (seq_parameter_set_rbsp_t *sps);

extern void MakePPSavailable (pic_parameter_set_rbsp_t *PicParSet, int id, pic_parameter_set_rbsp_t *pps);
extern void MakeSPSavailable (seq_parameter_set_rbsp_t *SeqParSet, int id, seq_parameter_set_rbsp_t *sps);
...
extern int InterpretSPS (seq_parameter_set_rbsp_t *sps,Bitstream *s);
extern int InterpretPPS (pic_parameter_set_rbsp_t *pps,seq_parameter_set_rbsp_t *sps,Bitstream *s);
